...
class TestCompleteWorkflows:
    ...
    @pytest.mark.integration
    def test_cascade_deletion_workflow(self, test_client: TestClient):
        """
    ...
    @pytest.mark.integration
    def test_multiple_users_multiple_courses_complex(self, test_client: TestClient):
        """
    ...
    @pytest.mark.integration
    def test_api_consistency_across_endpoints(self, test_client: TestClient):
        """
