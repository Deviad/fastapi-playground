...
class TestCoverageDebug:
    ...
    @pytest.mark.unit
    def test_simple_user_creation_debug(self, test_client: TestClient):
    ...
    @pytest.mark.unit
    def test_simple_course_creation_debug(self, test_client: TestClient):
    ...
    @pytest.mark.unit
    def test_get_all_users_debug(self, test_client: TestClient):
    ...
    @pytest.mark.unit
    def test_get_all_courses_debug(self, test_client: TestClient):
