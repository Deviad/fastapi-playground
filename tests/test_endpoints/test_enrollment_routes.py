...
class TestEnrollmentEndpoints:
    ...
    def test_enroll_user_in_course_success(
        self, test_client: TestClient, sample_user, sample_course
    ):
    ...
    @pytest.mark.unit
    def test_enroll_user_nonexistent_user(self, test_client: TestClient, sample_course):
    ...
    @pytest.mark.unit
    def test_enroll_user_nonexistent_course(self, test_client: TestClient, sample_user):
    ...
    def test_enroll_user_duplicate_enrollment(
        self, test_client: TestClient, sample_enrollment
    ):
    ...
    def test_get_user_courses_no_enrollments(
        self, test_client: TestClient, sample_user
    ):
    ...
    @pytest.mark.unit
    def test_get_user_courses_nonexistent_user(self, test_client: TestClient):
    ...
    def test_get_course_users_no_enrollments(
        self, test_client: TestClient, sample_course
    ):
    ...
    @pytest.mark.unit
    def test_get_course_users_nonexistent_course(self, test_client: TestClient):
    ...
    def test_multiple_enrollments_same_user(
        self, test_client: TestClient, sample_user, multiple_courses
    ):
    ...
    def test_multiple_enrollments_same_course(
        self, test_client: TestClient, multiple_users, sample_course
    ):
