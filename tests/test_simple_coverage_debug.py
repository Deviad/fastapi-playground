...
class TestSimpleCoverageDebug:
    ...
    @pytest.mark.unit
    def test_simple_course_creation(self, test_client: TestClient, mock_transactional_db):
    ...
    @pytest.mark.unit
    def test_simple_course_not_found(self, test_client: TestClient, mock_transactional_db):
