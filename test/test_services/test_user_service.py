...
from fastapi_playground_poc.application.web.service.user_service import UserService
from fastapi_playground_poc.application.web.dto.schemas import UserCreate
...
class TestUserService:
    ...
    async def test_create_user_direct_route_function(self, test_db: AsyncSession, mock_transactional_db):
        ...
        from fastapi_playground_poc.application.web.controller.user_routes import create_user
    ...
    async def test_get_user_direct_route_success(self, test_db: AsyncSession, sample_user, mock_transactional_db):
        ...
        from fastapi_playground_poc.application.web.controller.user_routes import get_user
    ...
    async def test_get_all_users_direct_route(self, test_db: AsyncSession, multiple_users, mock_transactional_db):
        ...
        from fastapi_playground_poc.application.web.controller.user_routes import get_all_users
