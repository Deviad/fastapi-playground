...
from fastapi_playground_poc.infrastructure.exception_handlers import (
...
class TestValidationExceptionHandler:
    ...
    async def test_validation_exception_handler_basic(self):
        ...
        # Test the handler
        with patch("fastapi_playground_poc.infrastructure.exception_handlers.logger") as mock_logger:
